...
doc_events = {
	...
	"CRM Deal": {
		"on_update": ["crm.integrations.erpnext.customer.create_customer_in_erpnext"],
	},
	"Sales Order": {
		"before_validate": ["crm.integrations.erpnext.customer.create_customer_on_sales_order"],
	},
	"Item": {
